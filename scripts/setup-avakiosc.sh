...
wget -O /etc/systemd/system/avakiosc.service https://raw.githubusercontent.com/DHPKE/AVAkiOSC/main/packaging/systemd/avakiosc.service
wget -O /etc/systemd/system/avakiosc-webadmin.service https://raw.githubusercontent.com/DHPKE/AVAkiOSC/main/packaging/systemd/avakiosc-webadmin.service
